...
export type Permission = 'video:read' | 'video:create' | 'video:update' | 'video:publish' | 'video:delete' | 'video:stream' | 'admin:read' | 'admin:create' | 'admin:update' | 'admin:delete' | 'audit:read' | 'security:manage' | 'analytics:read';
